...
@section('container')
    ...
    <div class="h-sreen bg-custom-blue">
        ...
        <div class="w-full h-full px-4 pt-7 bg-white" style="border-radius: 30px 30px 0px 0px">
            ...
            <form 
                action="{{ $data_ayah ? route('update-data-ayah') : route('data-ayah') }}" 
                method="post" 
                enctype="multipart/form-data" class="submit-form">
                    ...
                    <div class="mb-3 block relative">
                        ...
                        name="alamat"
                        id="alamat" 
                        value="{{ old('alamat', $data_ayah->alamat ?? '') }}"
                        autocomplete="on"
                        autofocus
                        class="block rounded-t-2xl px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-900 bg-gray-50 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-gray-300 peer focus:border-b-2 focus:border-b-custom-blue" 
                        placeholder=" " />
                    ...
                    <div class="mb-3 block relative">
                        ...
                        name="pekerjaan"
                        id="pekerjaan" 
                        value="{{ old('pekerjaan', $data_ayah->pekerjaan ?? '') }}"
                        autocomplete="on"
                        autofocus
                        class="block rounded-t-2xl px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-900 bg-gray-50 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-gray-300 peer focus:border-b-2 focus:border-b-custom-blue" 
                        placeholder=" " />
                    ...
                    <div class="mb-3 block relative border-b-2 border-gray-300 pb-2">
                        ...
                        <div class="flex pt-3" id="jenis-kelamin">
                            <div class="flex items-center">
                                ...
                                {{ old('status', $data_ayah->status ?? '') == 'masih hidup' ? 'checked' : '' }}>
                                <label 
                                for="masih-hidup" 
                            ...
                            <div class="flex items-center ms-3">
                                ...
                                name="status" 
                                class="w-4 h-4 text-custom-blue bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-2"
                                {{ old('status', $data_ayah->status ?? '') == 'meninggal' ? 'checked' : '' }}>
                                <label 
                                for="meninggal" 
                    ...
                    <div class="mb-3 block relative">
                        ...
                        id="tempat_lahir" 
                        autocomplete="on"
                        value="{{ old('tempat_lahir', $data_ayah->tempat_lahir ?? '') }}"
                        class="block rounded-t-2xl px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-900 bg-gray-50 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-gray-300 peer focus:border-b-2 focus:border-b-custom-blue" 
                        placeholder=" " />
                        <label 
                        for="tempat_lahir"
                    ...
                    <div class="mb-3 block relative">
                        ...
                        id="tanggal_lahir" 
                        autocomplete="on"
                        value="{{ old('tanggal_lahir', $data_ayah->tanggal_lahir ?? '') }}"
                        class="block rounded-t-2xl px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-900 bg-gray-50 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-gray-300 peer focus:border-b-2 focus:border-b-custom-blue" 
                        placeholder=" " />
                        <label 
                        for="tanggal_lahir"
