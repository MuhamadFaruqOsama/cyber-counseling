...
@section('container')
    ...
    <div class="h-sreen bg-custom-blue">
        ...
        <div class="text-center py-3.5">
            ...
            <div class="font-semibold text-md text-white text-base">Personal Identity</div>
        </div>
        {{-- title --}}
        ...
        <div class="w-full h-full px-4 pt-7 bg-white" style="border-radius: 30px 30px 0px 0px">
            <div class="relative h-11 w-full min-w-[200px] mb-4">
                ...
                <form 
                action="{{ $data_diri ? route('update-data-diri') : route('data-diri') }}" 
                method="post" 
                enctype="multipart/form-data" class="submit-form">
                    ...
                    <div class="block pb-10 mt-4">
                        ...
                        data-text="Next"
                        class="btn-submit-form w-full py-3.5 font-bold block relative rounded-3xl text-white bg-custom-blue">Next</button>
                    </div>
