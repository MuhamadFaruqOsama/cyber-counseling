        ...
        <div class="w-full bg-white" style="border-radius: 0px 30px 0px 0px">
            ...
            <div class="flex justify-center items-center h-screen">
                <div class="form-login w-full max-w-md px-4">
                    <form action="{{ route('change-password') }}" method="POST" class="submit-form">
                        ...
                        class="w-full bg-custom-blue my-0 py-3.5 text-white font-semibold rounded-3xl mt-4 btn-submit-form">Save Changes</button>
                        {{-- button submit --}}
